...
- Changes planned: canonical UX spec, change/decision/task continuity and new contract/dependency/integration records.
...
- Open follow-up: CI/review, then separately governed implementation slices.
