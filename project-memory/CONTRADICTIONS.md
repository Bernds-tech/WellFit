...
## CTR-WERK-IMPACT-FEEDBACK-SELECTION-001
- Date: 2026-09-21
...
- Stronger/current evidence: exact functional SQL plus fresh live migration `20260921084055 ideenwerk_impact_feedback`; the exact head has five successful workflows, but those tests do not falsify the >50-unrelated-reviews case.
- Current runtime impact: none observed; `werk_impact_reviews` and the related impact/AI tables are currently zero-row.
