...
### Latest WERK continuation: WERK-LAB-003
2026-09-06: local source and contract checks passed for complete August regional stocks and 3072 occupation/state stock pairs. Read the current section of WERK_LABOUR_HANDOFF.md first. Publication and remote CI for this new change set remain pending until the next receipt.
