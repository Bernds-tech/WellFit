...
- Result: exact implementation head `f2b2bdb89655bea3398687a35540704b091672d7` passed Build #1198, Container Build #183, Database Package Tests #175 and Project Memory Guard/Quality/Status; normal PR #390 merged to WellFit-now main as `d374e4db4777406d93a8aad72adc10ab47db216f`. No current rendered evidence proves the intended head/body behavior on the exact public Site, so visual verification remains open.
- Evidence: merged WellFit PR #25; WFG-CR-007; CTR-WFG-006; WellFit-now PR #390; WellFit-now PR #403 explicitly preserved the separate Puppet visual-verification loop.
...
- Next step: open the actual Site via ChatGPT Sites/Edit, synchronize/verify the relevant articulated behavior on the exact preview, then deliberately publish only after visual evidence.
...
- Starting state: owner live review rejected the viewport-clamped/catch-up model because Rudi appeared detached from the page and could effectively float relative to content.
- Action: WFG-CR-008 established DOM-surface authority. WellFit-now PR #401 implemented the F podium, real DOM surfaces, no viewport clamp, full-offscreen + settle catch-up, visible grounded walk/climb routes, DOM-owned locomotion, CTA gaze without relocation and deletion of the parallel viewport/chapter controller. PR #402 hardened static/reduced-motion/WebGL failure lifecycle and initial clip loading. WellFit PR #34 advanced the exact Site-sync manifest to the hardened source.
- Technical result: hardened runtime source is WellFit-now merge `b07d39938aeab4e32eddac7d19b8e15e22afacb7`. WellFit-now PR #403 exact head `a0f2f62793f1abf8403a60871eea84a35e9c2e9d` passed Build #1305, Container #290, Database #282 and Project Memory Guard #132 / Quality #140 / Status #148, then squash-merged as `40af0c25725e4bec096db690da808ad669691f2e`, closing the technical Rudi task/lock without claiming Site acceptance.
- Evidence: WFG-CR-008; WellFit-now PRs #401/#402/#403; WellFit `RUDI_SITE_SYNC_MANIFEST.json`; released `XLOCK-WF-RUDI-WORLD-20260905` and `XLOCK-WF-RUDI-FALLBACK-20260906`.
- Negative/fail-closed path: no backend/auth/data/mission/reward/economy/location/camera/native runtime changes; no claim that GitHub modifies the separate public ChatGPT Site; no acceptance from CI alone. Site version 105 and the deleted viewport/props scenes are historical only.
- Rollback/recovery: if the technical runtime itself proves defective, reopen a fresh scoped WellFit-now task against hardened source; Site-specific perceptual failures are first routed through WellFit graphical authority. The public Site remains separately deployable.
- Falsification question: any exact public-Site preview showing visible hovering, detached footing, Rudi remaining onscreen after his bound surface leaves, unexplained teleportation, air-climbing, broken layer/header/CTA interaction or failed reduced-motion/static fallback invalidates graphical acceptance.
- Next step: synchronize hardened source `b07d39938aeab4e32eddac7d19b8e15e22afacb7` into the exact editable `wellfit-bewegt` Site source via the current manifest, execute all ten real-WebGL/fallback checks and deliberately publish only after they pass.
