...
required=['WELLFIT_MASTER_STATE.json','PROJECT_COORDINATION.json','CROSS_REPO_DEPENDENCIES.json','CONTRACT_REGISTRY.json','INTEGRATION_GATES.json','CROSS_REPO_LOCKS.md','CONVERGENCE_LEDGER.json','WELLFIT_MASTER_NEXT_ACTION.md','PROTOCOL.md']
errors=[]
