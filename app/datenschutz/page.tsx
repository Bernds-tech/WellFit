...
export default function Datenschutz() {
  return (
    <LegalThemeShell><main className="legal-page">
      ...
      <section><h2>Umfang dieser Website</h2><p>Dies ist ausschließlich eine Informations- und Landingpage über die geplante Entwicklung von WellFit. Die Login-, Registrierungs- und Passwortoberflächen sind interaktive Designvorschauen: Eingaben werden weder an WellFit übertragen noch dort gespeichert; es entstehen keine Konten oder E-Mails. Die Website enthält keine WellFit-Anwendung, keine produktiven Missionen, keine WFXP- oder WFP-Konten, keine Standortprüfung, keine Checkpoint-Wertung, kein Bürgermeistersystem und keinen Partnereditor.</p></section>
